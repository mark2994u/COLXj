...
import org.ccbcj.net.discovery.HttpDiscovery;
import org.ccbcj.params.*;
import org.ccbcj.script.Script;
import org.ccbcj.script.ScriptBuilder;
import org.ccbcj.script.ScriptChunk;
import org.ccbcj.script.ScriptOpCodes;
...
import org.ccbcj.utils.VersionTally;
...
public abstract class NetworkParameters {
    ...
    /** Returns discovery objects for seeds implementing the Cartographer protocol. See {@link org.ccbcj.net.discovery.HttpDiscovery} for more info. */
    ...
    /**
     * First byte of a base58 encoded address. See {@link org.ccbcj.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link org.ccbcj.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link org.ccbcj.core.AlertMessage}s. You can use {@link org.ccbcj.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
