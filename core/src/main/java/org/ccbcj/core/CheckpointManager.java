...
import org.ccbcj.store.FullPrunedBlockStore;
 ...
 * {@link org.ccbcj.store.SPVBlockStore}s. They are not used by fully validating mode, which instead has a
...
public class CheckpointManager {
    ...
    /** Loads the default checkpoints bundled with ccbcj */
    ...
    /** Returns a checkpoints stream pointing to inside the ccbcj JAR */
