...
import org.ccbcj.net.*;
import org.ccbcj.net.discovery.*;
...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * FP rate is chosen for performance rather than privacy. If a future version of ccbcj fixes the known
     ...
     * {@link org.ccbcj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link org.ccbcj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.ccbcj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.ccbcj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.ccbcj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link org.ccbcj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link org.ccbcj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link org.ccbcj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.ccbcj.core.Peer#ping()}.
     */
     ...
     * and easy way for a user to upgrade a ccbcj based app running in SPV mode to fully validating security.
     */
