...
/**
 * <p>A KeyChainGroup is used by the {@link org.ccbcj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.ccbcj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.ccbcj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.ccbcj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
