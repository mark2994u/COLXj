...
import org.ccbcj.core.Message;
import org.ccbcj.core.listeners.*;
import org.ccbcj.core.TransactionConfidence.*;
import org.ccbcj.crypto.*;
import org.ccbcj.script.*;
import org.ccbcj.signers.*;
import org.ccbcj.utils.*;
import org.ccbcj.wallet.Protos.Wallet.*;
import org.ccbcj.wallet.WalletTransaction.*;
import org.ccbcj.wallet.listeners.KeyChainEventListener;
import org.ccbcj.wallet.listeners.ScriptsChangeEventListener;
...
import org.ccbcj.wallet.listeners.WalletCoinsSentEventListener;
import org.ccbcj.wallet.listeners.WalletEventListener;
import org.ccbcj.wallet.listeners.WalletReorganizeEventListener;
import org.slf4j.*;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.ccbcj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
     ...
     * {@link org.ccbcj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.ccbcj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.ccbcj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.ccbcj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.ccbcj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.ccbcj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.ccbcj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.ccbcj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.ccbcj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.ccbcj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.ccbcj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.ccbcj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.ccbcj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * key, after loading a wallet produced by previous versions of ccbcj. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.ccbcj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.ccbcj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.ccbcj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.ccbcj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.ccbcj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.ccbcj.crypto.KeyCrypter,
     ...
     * {@link org.ccbcj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.ccbcj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.ccbcj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.ccbcj.signers.TransactionSigner.MissingSignatureException}
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.ccbcj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.ccbcj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
