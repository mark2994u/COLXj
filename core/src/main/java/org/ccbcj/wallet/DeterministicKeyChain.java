...
import org.ccbcj.core.BloomFilter;
 ...
 * {@link org.ccbcj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link org.ccbcj.crypto.MnemonicCode},
 ...
 * {@link org.ccbcj.crypto.DeterministicKey#serializePubB58(org.ccbcj.core.NetworkParameters)}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link org.ccbcj.crypto.DeterministicKey#deserializeB58(org.ccbcj.crypto.DeterministicKey, String, org.ccbcj.core.NetworkParameters)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(org.ccbcj.crypto.DeterministicKey,KeyChainType keyChaintype)}.</p>
 *
 * <p>This class builds on {@link org.ccbcj.crypto.DeterministicHierarchy} and
 * {@link org.ccbcj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
    ...
    public List<DeterministicKey> getKeys(KeyPurpose purpose, int numberOfKeys) {
        ...
        try {
            ...
            for (int i = 0; i < numberOfKeys; i++) {
                ...
                // by any real problem reports from ccbcj users, but I've heard of cases via the grapevine of
     ...
     * The returned key can be serialized and then passed into {@link #watch(org.ccbcj.crypto.DeterministicKey)}
     ...
     * @see org.ccbcj.wallet.MarriedKeyChain
     */
