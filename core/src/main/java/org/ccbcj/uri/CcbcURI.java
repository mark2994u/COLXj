...
import org.ccbcj.params.AbstractBitcoinNetParams;
...
public class CcbcURI {
    ...
    /**
     * URI for Bitcoin network. Use {@link org.ccbcj.params.AbstractBitcoinNetParams#BITCOIN_SCHEME} if you specifically
     * need Bitcoin, or use {@link org.ccbcj.core.NetworkParameters#getUriScheme} to get the scheme
    ...
    /**
     * Constructs a new CcbcURI from the given string. Can be for any network.
     *
     ...
     */
    public CcbcURI(String uri) throws BitcoinURIParseException {
        this(null, uri);
    }
     ...
     */
    public CcbcURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        checkNotNull(input);
    ...
    public String toString() {
        StringBuilder builder = new StringBuilder("CcbcURI[");
        boolean first = true;
