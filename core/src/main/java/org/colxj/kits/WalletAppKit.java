...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV colxj app. Instantiate it with a directory
 ...
 * It is to make it easier to fit colxj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing colxj
...
public class WalletAppKit extends AbstractIdleService {
     ...
     * {@link org.colxj.core.DownloadProgressTracker} is a good choice. This has no effect unless setBlockingStartup(false) has been called
     ...
     * block sync faster for new users - please refer to the documentation on the colxj website for further details.
     */
