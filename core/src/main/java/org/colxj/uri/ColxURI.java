...
public class ColxURI {
    ...
    /**
     * Constructs a new ColxURI from the given string. Can be for any network.
     *
     ...
     */
    public ColxURI(String uri) throws BitcoinURIParseException {
        this(null, uri);
    }
     ...
     */
    public ColxURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        checkNotNull(input);
    ...
    public String toString() {
        StringBuilder builder = new StringBuilder("ColxURI[");
        boolean first = true;
