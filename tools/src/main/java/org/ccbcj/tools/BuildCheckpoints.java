...
import org.ccbcj.core.listeners.NewBestBlockListener;
...
public class BuildCheckpoints {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Configure ccbcj to fetch only headers, not save them to disk, connect to a local fully synced/validated
